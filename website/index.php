...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <div class="header clearfix">
        <nav>
          <ul class="nav nav-pills pull-right">
            <li role="presentation" class="active"><a href="index.php?page=home">Home</a></li>
            <li role="presentation"><a href="index.php?page=txt_to_db">TXT-TO-DB</a></li>
            <li role="presentation"><a href="index.php?page=cel_upload">Upload CEL-Files</a></li>
          </ul>
        </nav>
      ...
      <div class="jumbotron">
		<?php
			//Dateinamen rausschreiben
			$p_name = isset($_GET['page']) ? $_GET['page'] : "default";
			//Pfad zusammensetzen
